...
import com.huang.bchtsystem.View.Adapter.HorizontalScrollViewAdapter;
...
//			mContainer = (LinearLayout) getChildAt(0);
	...
	public void notifyCurrentImgChanged()
	{
		...
		{
			mContainer.getChildAt(i).setBackgroundResource(R.color.drey);
		}
	 ...
	 * @param mAdapter
	 */
	public void initDatas(HorizontalScrollViewAdapter mAdapter,int size)
	{
